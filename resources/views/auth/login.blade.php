<x-guest-layout>
    ...
    <div class="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
        <div
            ...
            <div
                class="p-4 py-6 text-white bg-indigo-700 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
                <div class="my-3 text-4xl font-bold tracking-wider text-center">
                    <a href="#">UNIVREC</a>
                </div>
                <p class="mt-6 font-normal text-center text-gray-300 md:mt-0">
                    Build Your Entire Team Anywhere In The World
                </p>
                <ul class="mt-6 font-bold text-gray-300 md:mt-0">
                    <li><i class="fas fa-check mr-3"></i>Effective Candidate Matching</li>
                    <li><i class="fas fa-check mr-3"></i>Showcase Page For Job Listing</li>
                    <li><i class="fas fa-check mr-3"></i>Chat Between Recuiter And Candidate</li>
                    <li><i class="fas fa-check mr-3"></i>Several Major Universities Can Register</li>
                </ul>
                ...
                <form action="{{ route('login') }}" method="POST" class="flex flex-col space-y-5">
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex items-center justify-between">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="text-sm text-blue-600 hover:underline focus:text-blue-800">Forgot
                                    Password?</a>
                            @endif
                        </div>
                    ...
                    <div>
                        <button type="submit"
                            ...
                            duration-300 bg-indigo-700 rounded-md shadow hover:bg-indigo-600 focus:outline-none 
                            focus:ring-indigo-200 focus:ring-4">
                            {{ __('Login') }}
                        </button>
                    </div>

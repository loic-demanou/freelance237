<x-app-layout>
    ...
    <div class="container">
        <h2 class="mt-3">Tell us something about you</h2>
        <form action="{{ route('user-detail.store') }}" method="post">
            ...
            <div class="col-8 mx-36 offset-2 mb-2">
                <div class="form-group">
                    ...
                    <textarea name="summary" id="user-textarea" autocomplete="summary" cols="30" rows="4" class="form-control">{{ old('summary') }}</textarea>
                    @error('summary')
                    <span class="text-red-400 text-sm block" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <button type="submit" class="btn btn-primary mt-3 mx-36 offset-2">Validate</button>

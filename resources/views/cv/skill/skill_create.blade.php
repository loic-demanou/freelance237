<x-app-layout>
    ...
    <div class="container">
        <h2 class="mt-3">Skill details</h2>
        <form action="{{ route('skill.store') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-8 mx-36 offset-2 my-3">
                    <div class="form-group">
                        <label for="name" class="mb-1">Name
                ...
                <div class="col-8 mx-36 offset-2 mb-2">
                    <div class="form-group">
                        ...
                        value="{{ old('rating') }}" autocomplete="rating" autofocus>
                        @error('rating')
                        <span class="text-red-400 text-sm block" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <button type="submit" class="btn btn-primary mt-3 mx-36 offset-2">Create skill</button>

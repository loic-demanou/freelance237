<x-app-layout>
    ...
    <div class="container">
        <h2 class="mt-3">Education details</h2>
        <form action="{{ route('education.store') }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-8 mx-36 offset-2 mb-2">
                    <div class="form-group">
                        ...
                        value="{{ old('school_location') }}" autocomplete="school_location" autofocus>
            ...
            <div class="row">
                <div class="col-8 mx-36 offset-2 mb-2">
                    <div class="form-group">
                        ...
                        value="{{ old('degree') }}" autocomplete="degree" autofocus>
                        @error('degree')
                        <span class="text-red-400 text-sm block" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-8 mx-36 offset-2 mb-2">
                    <div class="form-group">
                        ...
                        value="{{ old('field_of_study') }}" autocomplete="field_of_study" autofocus>
            ...
            <div class="row mx-36 offset-2 mb-2" >
                <div class="col-4">
                    <div class="form-group">
                        ...
                        value="{{ old('graduation_start_date') }}" autocomplete="graduation_start_date" autofocus>
                ...
                <div class="col-4 ">
                    <div class="form-group">
                        ...
                        value="{{ old('graduation_end_date') }}" autocomplete="graduation_end_date" autofocus>
            ...
            <button type="submit" class="btn btn-primary mt-3 mx-36 offset-2">Create Education</button>

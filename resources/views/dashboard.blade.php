                      ...
                      @choice('proposition|propositions', $job->proposals)) :</span>
                                ...
                                <ul class="list-none ml-4">
                                    @foreach ($job->proposals as $proposal)
                                        <li class="mt-2">• Envoyé par <strong>{{ $proposal->user->name }}</strong>
                                            pour le job
                        ...
                        @endif --}}
                                        ...
                                        @else
                                            <a href="{{ route('confirm.proposal', $proposal->id) }}"
                                                class="bg-green-500 text-md py-2 px-2 mt-5  inline-block text-white hover:bg-green-300 hover:text-green-500 duration-200 transition rounded">Valider
                                                la proposition</a>
